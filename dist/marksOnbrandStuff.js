...
var init = function init(e) {
	Array.from(document.getElementsByClassName('inPageLink')).forEach(function (element) {
		return element.addEventListener('click', changeArticle);
	});
};
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket('ws://' + hostname + ':' + '57998' + '/');
